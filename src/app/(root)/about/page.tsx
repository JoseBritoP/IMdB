...
export default function page() {
  return (
    <section className='max-w-6xl mx-auto p-3 gap-4 space-y-4 pt-5'>
      <h1 className='text-3xl text-amber-600 font-semibold'>About</h1>
      <div className='text-start text-xl font-medium space-y-5'>
